                    ...
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            ...
                            <div class="item-action top-down delay-6">
                                <a href="video.php?id=13" class="btn btn-hover">
                ...
                <div class="hero-slide-item">
                    ...
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            ...
                            <div class="item-action top-down delay-6">
                                <a href="video.php?id=9" class="btn btn-hover">
                                    <i class="bx bxs-right-arrow"></i>
                                    <span>Watch now</span>
                                </a>
                            </div>
                ...
                <div class="hero-slide-item">
                    ...
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            ...
                            <div class="item-action top-down delay-6">
                                <a href="video.php?id=6" class="btn btn-hover">
                                    <i class="bx bxs-right-arrow"></i>
                                    <span>Watch now</span>
                                </a>
                            </div>
                ...
                <div class="hero-slide-item">
                    ...
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            ...
                            <div class="item-action top-down delay-6">
                                <a href="video.php?id=3" class="btn btn-hover">
                                    <i class="bx bxs-right-arrow"></i>
                                    <span>Watch now</span>
                                </a>
                            </div>
        ...
        <div class="top-movies-slide">
            <div class="owl-carousel" id="top-movies-slide">
                ...
                <div class="movie-item">
                    <a href="video.php?id=12"><img src="images/Avatar2.jpeg" alt=""></a>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                    <a href="video.php?id=15"><img src="images/war.jpeg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            WAR
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                    <a href="video.php?id=14"><img src="images/imthat.png" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            I Am That Change 
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                    <a href="video.php?id=5"><img src="images/saaho.jpeg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            SAAHO
                        </div>
