...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <?php
              $fetchVideos = mysqli_query($conn, "SELECT * FROM movies,genre where movies.id=genre.id and genre.genre='scifi'");
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="movies-slide carousel-nav-center owl-carousel">
            <?php
              $fetchVideos = mysqli_query($conn, "SELECT * FROM movies,genre where movies.id=genre.id and genre.genre='action'");
              while($row = mysqli_fetch_assoc($fetchVideos)){
              $location = $row['imageloc'];
              $name = $row['title'];
              $time = $row['runtime'];
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="movies-slide carousel-nav-center owl-carousel">
            <?php
              $fetchVideos = mysqli_query($conn, "SELECT * FROM movies,genre where movies.id=genre.id and genre.genre='drama'");
              while($row = mysqli_fetch_assoc($fetchVideos)){
              $location = $row['imageloc'];
              $name = $row['title'];
              $time = $row['runtime'];
